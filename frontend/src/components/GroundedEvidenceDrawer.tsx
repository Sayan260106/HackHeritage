                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 pt-0.5">
                    {item.coast && item.coast !== 'all' && (
                      <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-blue-950/80 text-blue-300 border border-blue-800/80 font-semibold">
                        {item.coast.toUpperCase()} COAST
                      </span>
                    )}
                    {item.jurisdiction && (
                      <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-indigo-950/80 text-indigo-300 border border-indigo-800/80">
                        {item.jurisdiction.replace(/_/g, ' ')}
                      </span>
                    )}
                    {item.topicCategory && (
                      <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-slate-900 text-slate-300 border border-slate-700/80">
                        {item.topicCategory}
                      </span>
                    )}
                  </div>
